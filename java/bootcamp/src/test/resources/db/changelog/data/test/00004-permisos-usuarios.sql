...
INSERT INTO core_mapping_authorities(MAPPING_ID, AUTHORITY_ID) VALUES ((select mapping_id from core_mappings where pattern='/biblio/insert'), (select authority_id from core_authorities where name = 'READ_LIBRARY')); --/biblio/find                READ_LIBRARY


-- Position 99 = Last position
INSERT INTO core_mappings(PATTERN) VALUES ('/biblio/search');
INSERT INTO core_mapping_authorities(MAPPING_ID, AUTHORITY_ID) VALUES ((select mapping_id from core_mappings where pattern='/biblio/search'), (select authority_id from core_authorities where name = 'READ_LIBRARY')); --/biblio/find                READ_LIBRARY


-- Position 99 = Last position
INSERT INTO core_mappings(PATTERN) VALUES ('/biblio/delete');
INSERT INTO core_mapping_authorities(MAPPING_ID, AUTHORITY_ID) VALUES ((select mapping_id from core_mappings where pattern='/biblio/delete'), (select authority_id from core_authorities where name = 'READ_LIBRARY')); --/biblio/find                READ_LIBRARY
